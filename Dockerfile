...
ARG NEXT_PUBLIC_LEGACY_PUBLISHABLE_KEY
...
ARG PLATFORM_AUTH_PUBLISHABLE_KEY

ENV NEXT_PUBLIC_LEGACY_PUBLISHABLE_KEY=$NEXT_PUBLIC_LEGACY_PUBLISHABLE_KEY
...
ENV PLATFORM_AUTH_PUBLISHABLE_KEY=$PLATFORM_AUTH_PUBLISHABLE_KEY
