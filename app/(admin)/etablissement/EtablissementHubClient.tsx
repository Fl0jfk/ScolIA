...
export default function EtablissementHubClient() {
  ...
  useEffect(() => {
    const target = resolveLegacyPillarTab("etablissement", searchParams.get("tab"));
  ...
  if (searchParams.get("tab") && resolveLegacyPillarTab("etablissement", searchParams.get("tab"))) {
