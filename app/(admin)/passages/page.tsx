  ...
  return (
    <ModulePageShell maxWidthClass="max-w-3xl">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-3xl border border-violet-200 bg-violet-50/40 p-6 text-sm text-slate-700">
          <p className="font-bold text-violet-950">Facturation cantine</p>
          <p className="mt-1">
            Réglage forfait (droit) ou réel (passages self). Prépare les brouillons par foyer.
          </p>
          <Link
            href="/passages/facturation"
