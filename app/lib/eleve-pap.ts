/**
 * Dispositifs d’accompagnement scolaire (PAP / PAI / PPS).
 * Détection par titre de document — partagé client / serveur.
 */

export type AccompagnementKind = "pap" | "pai" | "pps";
...
/** Détecte PAP / PAI / PPS d’après le titre du document. */
...
/** Tout document PAP, PAI ou PPS (même circuit d’accès pédagogique). */
