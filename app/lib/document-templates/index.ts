...
export {loadGeneratedIndex, saveGeneratedDocument, loadGeneratedDocument, loadGeneratedFileBytes, generatedFileKey, contentTypeForFormat, extensionForFormat} from "@/app/lib/document-templates/storage";
