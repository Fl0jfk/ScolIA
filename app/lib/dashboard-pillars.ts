...
export const DASHBOARD_PILLARS: DashboardPillarDef[] = [
  ...
  },
  {
    ...
    title: "Établissement",
    href: "/etablissement",
    description: "Paramètres, événements, portes ouvertes, annuaire, communication",
    allowedRoles: [
      ...DIRECTIONS,
      "administratif",
      "accueil",
...
const PRIMARY_PILLAR_BY_MODULE: Record<string, DashboardPillarId> = {
  ...
  documents: "services",
  "office-writer": "services",
  "office-calc": "services",
  "office-impress": "services",
  qrcreator: "services",
  channels: "services",
  assistance: "services",
  ...
  "absences-accueil-consultation": "vie_scolaire",
