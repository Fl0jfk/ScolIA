...
import { listFamilleNotes } from "@/app/lib/famille-notes-db";

/** Notes en cours (et historiques) des enfants liés — sans exiger la clôture. */
export async function GET(req: Request) {
  ...
  const notes = await listFamilleNotes(gate.ctx.etablissementId, eleveIds);
