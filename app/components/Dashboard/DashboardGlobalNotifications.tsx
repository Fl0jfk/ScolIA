  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute left-0 top-[calc(100%+0.5rem)] z-40 w-[min(20rem,calc(100vw-2rem))] origin-top-left transition duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] ${
          open
